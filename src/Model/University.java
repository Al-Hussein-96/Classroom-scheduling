...
public class University {
    ...
    public University() {
        ...
        teachers.add(new Teacher(TeacherName.A, subjectNames, p, typeLectures, specializationNames));
        teachers.add(new Teacher(TeacherName.B, subjectNames, p, typeLectures, specializationNames));
        teachers.add(new Teacher(TeacherName.C, subjectNames, p, typeLectures, specializationNames));
        teachers.add(new Teacher(TeacherName.D, subjectNames, p, typeLectures, specializationNames));
        teachers.add(new Teacher(TeacherName.E, subjectNames, p, typeLectures, specializationNames));
        teachers.add(new Teacher(TeacherName.F, subjectNames, p, typeLectures, specializationNames));
        teachers.add(new Teacher(TeacherName.G, subjectNames, p, typeLectures, specializationNames));
